 ...
 * 
 */
public class AdvWood2D extends AdvGradientVectorNoise2D {

	/**
	 * This constructor creates an instance of Advanced Wood Noise with the
	 * entered parameters.
	 * 
	 ...
	 * @extends AdvGradientVectorNoise2D
	 */
	public AdvWood2D(int frequencyWidth, int frequencyHeight, int width, int height,
	...
	protected void populateArray() throws IllegalArgumentException {
		...
		for (int i = 0; i < super.getOctaves(); ++i) {
			Wood2D temp = new Wood2D(tempFrequencyWidth,
