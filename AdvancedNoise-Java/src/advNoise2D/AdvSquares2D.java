...
/**
 * This class initialize an instance of Squares Noise in 2D with the concepts of
 ...
 * 
 */
public class AdvSquares2D extends AdvGradientVectorNoise2D {
	 ...
	 * @extends AdvGradientVectorNoise2D
	 */
	public AdvSquares2D(int frequencyWidth, int frequencyHeight, int width, int height,
	...
	protected void populateArray() throws IllegalArgumentException {
		...
		for (int i = 0; i < super.getOctaves(); ++i) {
			Squares2D temp = new Squares2D(tempFrequencyWidth,
