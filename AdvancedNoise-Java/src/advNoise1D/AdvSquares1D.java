...
/**
 * This class initialize an instance of Squares Noise with the concepts of
 ...
 * 
 */
public class AdvSquares1D extends AdvGradientVectorNoise1D {
	/**
	 ...
	 * @extends AdvGradientVectorNoise1D
	 */
	public AdvSquares1D(int frequency, int length, int octaves,
